...
public:
  ...
  void drawSprite(const uint8_t *bmp, int8_t x, int8_t y, uint8_t w, uint8_t h);
  void drawSprite(const uint8_t *bmp, int8_t x, int8_t y);
  void drawSpriteMirror(const uint8_t *bmp, int8_t x, int8_t y, uint8_t w, uint8_t h);
  void drawSpriteMirror(const uint8_t *bmp, int8_t x, int8_t y);
